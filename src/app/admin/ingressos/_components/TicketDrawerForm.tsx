...
export function TicketDrawerForm({ open, onClose, ticket, onSaved, eventOptions }: TicketDrawerFormProps) {
  ...
  const form = useForm<TicketFormData>({
    ...
    defaultValues: {
      ...
      quantity: undefined,
      min_quantity_per_purchase: undefined,
      max_quantity_per_purchase: undefined,
    ...
    if (open) {
      if (ticket) {
        form.reset({
          ...
          min_amount_for_installments: ticket.min_amount_for_installments ?? undefined,
          ...
          sale_start_date: ticket.sale_start_date ?? undefined,
          sale_end_date: ticket.sale_end_date ?? undefined,
